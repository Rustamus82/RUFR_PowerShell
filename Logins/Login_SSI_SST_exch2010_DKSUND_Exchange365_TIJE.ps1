...
$Global:UserCredDksund = Get-Credential adm-tije@dksund.dk -Message "DKSUND AD login & Exchange OnPrem"
...
#$Global:credo365 = Get-Credential adm-tije@dksund.dk -Message "login til  Office 365"
