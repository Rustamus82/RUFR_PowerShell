...
$Global:UserCredSST = Get-Credential sst.dk\adm_ghk -Message "SST AD login og import af AD modulet"
...
$Global:UserCredDksund = Get-Credential dksund\adm_ghk -Message "DKSUND AD login & Exchange OnPrem"
...
$Global:UserCredSSI = Get-Credential ssi\adm_ghk -Message "SSI AD login"
