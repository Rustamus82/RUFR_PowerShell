...
$Global:UserCredDksund = Get-Credential adm_krle@dksund.onmicrosoft.com -Message "DKSUND AD login, Exchange Online & Hybrid"
...
#$Global:UserCredDksund = Get-Credential dksund\adm_KRLE -Message "DKSUND AD login, Exchange Online & Hybrid"
