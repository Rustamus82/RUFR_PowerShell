...
$Global:UserCredSST = Get-Credential sst.dk\adm_afkh -Message "SST AD login og import af AD modulet"
...
$Global:UserCredDksund = Get-Credential dksund\adm_afkh -Message "DKSUND AD login & Exchange OnPrem"
...
#Get-Credential adm_afkh@dksund.onmicrosoft.com | Export-Clixml C:\RUFR_PowerShell\Logins\xml\rufr_o365.xml
#Save credential with password to vairable.
# Load credential from file
#$credo365 =  Import-Clixml C:\RUFR_PowerShell\Logins\xml\rufr_o365.xml

Import-Module MSOnline
$Global:credo365 = Get-Credential adm_afkh@dksund.onmicrosoft.com -Message "login til  Office 365"
...
$Global:UserCredSSI = Get-Credential ssi\adm_afkh -Message "SSI AD login"
...
if (-not(Get-PSDrive 'SSIAD' -ErrorAction SilentlyContinue)) {
    ...
    #alternativet creds: –Credential $(Get-Credential -Message 'Enter Password' -UserName 'SST.DK\adm_afkh') 
