...
$Global:UserCredDksund = Get-Credential adm-snt@dksund.dk -Message "DKSUND AD login & Exchange OnPrem"
...
$Global:credo365 = Get-Credential adm-snt@dksund.dk -Message "login til  Office 365"
