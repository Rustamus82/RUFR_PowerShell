...
$Global:UserCredDksund = Get-Credential dksund\adm-snt -Message "DKSUND AD login & Exchange OnPrem"
...
#Get-Credential adm-snt@dksund.onmicrosoft.com | Export-Clixml C:\RUFR_PowerShell\Logins\xml\rufr_o365.xml
...
$Global:credo365 = Get-Credential adm-snt@dksund.onmicrosoft.com -Message "login til  Office 365"
