...
$Global:UserCredSST = Get-Credential sst.dk\adm-aae -Message "SST AD login og import af AD modulet"
...
$Global:UserCredDksund = Get-Credential dksund\adx-anae -Message "DKSUND AD login & Exchange OnPrem"
...
$Global:credo365 = Get-Credential adx-anae@dksund.onmicrosoft.com -Message "login til  Office 365"
...
$Global:UserCredSSI = Get-Credential ssi\adx-anae -Message "SSI AD login"
