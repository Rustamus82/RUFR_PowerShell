...
$Global:UserCredSST = Get-Credential sst.dk\ -Message "SST AD login og import af AD modulet"
...
$Global:UserCredDksund = Get-Credential dksund\ -Message "DKSUND AD login & Exchange OnPrem"
...
$Global:credo365 = Get-Credential -Message "login til  Office 365"
...
$Global:UserCredSSI = Get-Credential ssi\ -Message "SSI AD login"
