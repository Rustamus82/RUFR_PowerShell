...
$SessionExchangeSST= New-PSSession -ConfigurationName Microsoft.Exchange -ConnectionUri http://S-EXC-MBX01-P.sst.dk/PowerShell/ -Authentication Kerberos -Credential $Global:UserCredSST
...
$Global:UserCredDksund = Get-Credential dksund\adm-jomh -Message "DKSUND AD login & Exchange OnPrem"
...
#Get-Credential adm-jomh@dksund.onmicrosoft.com | Export-Clixml C:\RUFR_PowerShell\Logins\xml\rufr_o365.xml
#Save credential with password to vairable.
# Load credential from file
#$credo365 =  Import-Clixml C:\RUFR_PowerShell\Logins\xml\rufr_o365.xml

Import-Module MSOnline
$Global:credo365 = Get-Credential adm-jomh@dksund.onmicrosoft.com -Message "login til  Office 365"
