...
$Global:UserCredDksund = Get-Credential dksund\adm-motj -Message "DKSUND AD login & Exchange OnPrem"
...
#Get-Credential adm-motj@dksund.onmicrosoft.com | Export-Clixml C:\RUFR_PowerShell\Logins\xml\rufr_o365.xml
