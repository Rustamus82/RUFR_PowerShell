...
$Global:UserCredDksund = Get-Credential adm-JOMH@dksund.dk -Message "DKSUND AD login & Exchange OnPrem"
...
#$Global:credo365 = Get-Credential adm-JOMH@dksund.dk -Message "login til  Office 365"
