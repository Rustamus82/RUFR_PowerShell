...
Connect-ExchangeOnline -UserPrincipalName "$global:UserInitial@dksund.dk" -ShowProgress $true -ShowBanner:$false 
#Connect-ExchangeOnline -Credential $Global:UserCredDksund -ShowProgress $true -ShowBanner:$false
#Connect-ExchangeOnline -UserPrincipalName "$global:UserInitial@dksund.dk" -ShowProgress $true 
