...
# trace message https://docs.microsoft.com/en-us/powershell/module/exchange/mail-flow/get-messagetrace?view=exchange-ps
Get-o365MessageTrace -RecipientAddress rufr@sundhedsdata.dk -StartDate 07/03/2019 -EndDate 07/04/2019