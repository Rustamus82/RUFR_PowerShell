<# 
.SYNOPSIS 
.\ad-grouplist.ps1 søger på ad-gruppe, viser combobox, hvis flere grupper matcher, og lister medlemmerne.
...
#> 
	...
	Begin{
		...
		If (!($comboCount -gt 0)){Write-Error "Ikke fundet nogen grupper der opfulder søgekriteriet $group !";Exit}
		...
		$Form.Text = "Vælg Gruppe, for at vise brugerne" + ($comboCount.ToString()) + " fundet"
		...
		$Okbutton.Text = "Vælg viste gruppe" 
