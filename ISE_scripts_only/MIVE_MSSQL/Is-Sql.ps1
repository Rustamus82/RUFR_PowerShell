...
If (($a.name).length -gt 0){"Sqlserver Installeret!"}else {Install-Module -Name SqlServer -AllowClobber -Scope CurrentUser}
$a=Get-Module PackageManagement
If (($a.name).length -gt 0){"Sqlserver Installeret!"}else {Write-Host "Du må ikke :-("}
Invoke-Sqlcmd
# SIG # Begin signature block
# MIIdAgYJKoZIhvcNAQcCoIIc8zCCHO8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCz+fYOjYcooAzF
# sU1uDx/CDUgsB2cMUk4MIZ0JEVEBA6CCGBMwggT+MIID5qADAgECAhANQkrgvjqI
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHdf0iZbFMF3821P5hVdG2ia
# 1xD/gD/mEpa7vDlnUYC+MA0GCSqGSIb3DQEBAQUABIIBACZ4/5Ju+qjDYPNZSfPN
# DjzKzL4YhhE8s+mlFqbNB9prgH9JBO5nNsjtPtB78zZkvvdGorf+P43O/3gLf9al
# ue6jzKKf0QtNcYdr/92sqg1eijhhRZAiCwDVFBintplxilD997vwpPWNv3u9nrqs
# xND26mRIjoauRBY0khQQ7dDCZrCJeRLH3/23XLJh2FuTJ3EALhVqbXVIuvG2XXaB
# rTNA2UbykQrngethVYOFBx2wIaZ9j0LBpXaPYUIZc4GVbfsEKmEUauGHpLFFC39W
# 5zA6jvrvMFooVJVt4Snr/SY3dPH45AjTi3xYfMkrHUB9EdMiR53eZ19sCUZqKw41
# yO6hggIwMIICLAYJKoZIhvcNAQkGMYICHTCCAhkCAQEwgYYwcjELMAkGA1UEBhMC
...
# SIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTIxMDcxMjA4MDg0
# M1owLwYJKoZIhvcNAQkEMSIEIHt3++uvKsK430EvrPkLmPtnzv6guJlIUO2o6cGi
# QjjnMA0GCSqGSIb3DQEBAQUABIIBAGPY9b/DuKSH/41gPp7oAazDelp1hjP3sXwZ
# lvreucAd4lA4YoOfkf716sbrATMQtAH83ZjrItsjoGRc7tcDj9zPw8/FDxCV3FMj
# 0BtlBCzfXNUn4+/Vud0ZnZuGfaaWr7LFFzfK7NxV3TX95/b60M9Z/RfTYDIRRs4K
# l+FXHvAiSRKxSE7qTbYYNYzXXWnhsxtn4RiIvlYreVw4gpI5z7ZadgVKTIZ38o1I
# z8Xtw+HD8+BoSWZiaeswHYOxCwM/HjjKefF/ptNnFcEWO5va6zu9Rm8F03QdgBzq
# kYn+JRay+m26dqCIVA+JlIrn1+da41gH3njh49nL6Cks7amA2Cs=
