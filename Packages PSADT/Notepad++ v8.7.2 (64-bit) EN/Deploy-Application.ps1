...
Try {
    ...
    [string]$ProductCode = ''
    [string]$installFile = "npp.8.7.2.Installer.x64.exe"
    ##*===============================================
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Show-InstallationWelcome -CloseApps 'notepad++' -AllowDefer -DeferTimes 3 -CheckDiskSpace -ForceCloseAppsCountdown 60
		...
		Remove-MSIApplications -Name 'Notepad++*' -WildCard -FilterApplication (,('Publisher','TeamViewer*','WildCard')) -ContinueOnError $true
