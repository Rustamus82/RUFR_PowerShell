...
Try {
    ...
    [String]$appName = 'Microsoft Account Reset'
    [String]$appVersion = '1.0.0'
    [String]$appArch = '64-bit'
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.2'
    [String]$appScriptDate = '27/09/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Show-InstallationWelcome -CloseApps 'OUTLOOK' -CheckDiskSpace -PromptToSave -BlockExecution -ForceCloseAppsCountdown 600
        Show-InstallationWelcome -CloseApps 'ms-teams,Teams' -CheckDiskSpace -ForceCloseAppsCountdown 600

        ## Show Progress Message (with the default message)
        Show-InstallationProgress

        ## <Perform Pre-Installation tasks here>
        #& autoworkplacejoin /leave
        ...
        Get-ChildItem "C:\Users" -directory | Remove-Item -Path {("{0}\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Microsoft Teams classic.lnk" -f $_.fullname)} -Recurse -force -ErrorAction SilentlyContinue

        #https://learn.microsoft.com/en-us/entra/identity/devices/howto-device-identity-virtual-desktop-infrastructure#microsofts-guidance
        ...
        Get-ChildItem "C:\Users" -directory | Remove-Item -Path {("{0}\AppData\Local\Packages\Microsoft.Windows.CloudExperienceHost_cw5n1h2txyew" -f $_.fullname)} -Recurse -force -ErrorAction SilentlyContinue

        #what if to see the actual packages in \*\AC\TokenBroker
        #Get-ChildItem "C:\Users" -directory |Remove-Item -Path {("{0}\AppData\Local\Packages\*\AC\TokenBroker" -f $_.fullname)} -Recurse -WhatIf -ErrorAction SilentlyContinue
        Get-ChildItem "C:\Users" -directory |Remove-Item -Path {("{0}\AppData\Local\Packages\*\AC\TokenBroker" -f $_.fullname)} -Recurse -force -ErrorAction SilentlyContinue
        ...
        [scriptblock]$HKCURegistrySettings = {
            Remove-RegistryKey -Key 'HKCU\SOFTWARE\Microsoft\IdentityCRL' -SID $UserProfile.SID
            Remove-RegistryKey -Key 'HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\AAD' -SID $UserProfile.SID
            Remove-RegistryKey -Key 'HKCU\SOFTWARE\Microsoft\Windows NT\CurrentVersion\WorkplaceJoin' -SID $UserProfile.SID
        ...
        Show-InstallationWelcome -CloseApps 'ms-teams,Teams' -CheckDiskSpace -ForceCloseAppsCountdown 1 -Silent
        & shutdown -r -f -t 15 /c "Your PC will be restarted, remember to save your data and close all other programs, unsaved data will be lost! Greetings CE team"
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Show-InstallationWelcome -CloseApps 'OUTLOOK' -CheckDiskSpace -PromptToSave -BlockExecution -ForceCloseAppsCountdown 600
        Show-InstallationWelcome -CloseApps 'ms-teams,Teams' -CloseAppsCountdown 600
    ...
    ElseIf ($deploymentType -ieq 'Repair') {
        ...
        Show-InstallationWelcome -CloseApps 'OUTLOOK' -CheckDiskSpace -PromptToSave -BlockExecution -ForceCloseAppsCountdown 600
        Show-InstallationWelcome -CloseApps 'ms-teams,Teams' -AllowDeferCloseApps -DeferTimes 3 -CheckDiskSpace -ForceCloseAppsCountdown 600
