...
Try {
    ...
    [String]$appName = '7-Zip 24.08 (x64 edition)'
    [String]$appVersion = '24.08.00.0'
    [String]$appArch = '64-bit'
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
	[string]$appScriptAuthor = 'Rust@m'
    [string]$ProductCode = '{23170F69-40C1-2702-2408-000001000000}'
    [string]$installFile = "7z2408-x64.msi"
    ##*===============================================
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Show-InstallationWelcome -CloseApps '7zFM' -CheckDiskSpace -CloseAppsCountdown 60

        ## Show Progress Message (with the default message)
        Show-InstallationProgress

        ## <Perform Pre-Installation tasks here>
        $7zipProdCode = (Get-InstalledApplication -Name ‘7-zip’).ProductCode
        Execute-ProcessAsUser -Path "$envWinDir\System32\MsiExec.exe" -Parameters "/X $7zipProdCode /QN MSIRMSHUTDOWN=`"2`""

        Remove-MSIApplications -Name '7-Zip*' -WildCard -FilterApplication (,('Publisher','Igor Pavlov','WildCard')) -AddParameters 'MSIRMSHUTDOWN=2' -ContinueOnError $true
        ...
        $ApplicationUninstall = get-itemproperty 'HKLM:\Software\Microsoft\Windows\CurrentVersion\Uninstall\*','HKLM:\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\*' | Where-Object { $_.DisplayName -like "7-Zip*"}
        ...
        Execute-MSI -Action Install -Path $installFile -AddParameters 'ALLUSERS=2,MSIRMSHUTDOWN=2'
