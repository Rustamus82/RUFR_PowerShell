$xaml = Get-Content -Path 'C:\LocalData\RUFR_PowerShell\UserMenu.xaml' -Encoding UTF8
...
$xaml | Set-Content -Path 'C:\LocalData\RUFR_PowerShell\UserMenu.xaml' -Encoding UTF8
