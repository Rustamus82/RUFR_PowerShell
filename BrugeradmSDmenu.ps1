...
function Show-Menu {
     ...
     Write-Host
     Write-Host " Tryk '1sst' for at oprette ny Fælles/Funktionspostkasse ExchangeSST (SST, DEP, STPS og NGC)" -foregroundcolor Cyan
     Write-Host
     ...
     Write-Host
     Write-Host " Skriv 'roomsst' for at oprette Mødelokalle i ExchangeSST (SST, DEP, STPS og NGC)" -foregroundcolor Cyan
     Write-Host
