...
Try {
	...
	[string]$appName = 'Reset Windows Saved Credentials'
	[string]$appVersion = ''
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.1'
	[string]$appScriptDate = '27/10/2020'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'Outlook,winword,excel,powerpnt' -AllowDefer -DeferTimes 3 -CheckDiskSpace -PromptToSave
        Show-InstallationWelcome -CloseApps 'lync,OneDrive,OneNote,teams' -CloseAppsCountdown 300
        ...
        Show-InstallationPrompt -Message 'DK: Dine gemte legitimationsoplysninger var fjerner fra Windows. Genstart venligst PC. -  ENG: You Windows saved credentials were removed. Restart your PC to complete process.' -ButtonRightText 'OK' -Icon Information -NoWait 
		...
		#If (-not $useDefaultMsi) { Show-InstallationPrompt -Message 'DK: Dine gemte legitimationsoplysninger var fjerner fra Windows. Genstart venligst PC. -  ENG: You Windows saved credentials were removed. Restart your PC to complete process.' -ButtonRightText 'OK' -Icon Information -NoWait  }
	}
