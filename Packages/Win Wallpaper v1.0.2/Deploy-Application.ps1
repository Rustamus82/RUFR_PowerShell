...
Try {
	...
	[string]$appName = 'DEP wallpaper'
	[string]$appVersion = '1.0.1'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '25/05/2021'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'NoAppToClose' -CheckDiskSpace -PersistPrompt
        ...
        #Set Module path
        $env:PSModulePath =  $env:PSModulePath + ";$dirSupportFiles\Modules"
        ...
        $DefaultWallpaperRootPath = Join-Path -Path $dirFiles -ChildPath "img0.jpg"
        ...
        $HDWallpaperRoot = Join-Path -Path $dirFiles -ChildPath "4K"
...
$DefaultWallpaperImagePath = Join-Path -Path $env:WINDIR -ChildPath "WEB\Wallpaper\Windows\img0.jpg" 
Set-WallPaper -Image "$DefaultWallpaperImagePath" -Style Fill
