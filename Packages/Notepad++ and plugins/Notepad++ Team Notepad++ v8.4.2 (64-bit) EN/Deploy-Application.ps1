...
Try {
	...
	[string]$appScriptDate = '27/07/2022'
	[string]$appScriptAuthor = 'Rust@m'
    [string]$ProductCode = ''
    [string]$installFile = "npp.8.4.2.Installer.x64.exe"
	##*===============================================
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Remove-MSIApplications -Name 'Notepad++*' -WildCard
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'notepad++' -CloseAppsCountdown 300
